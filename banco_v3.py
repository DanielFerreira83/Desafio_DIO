...
def criar_usuario(clientes):  # nome. data de nasciemnto, spf, enredeço / chave - valar
    cpf = input('CPF: ')
    cliente = filtra_usuario(cpf, clientes)
    ...
    endereco = input(
        'Endereço (logradouro - nro - bairro - cidade/cigla estado): ')
    d_nasc = input('Data de nascimento (dd-mm-aaaa): ')

    cliente = PessoaFisica(
        nome=nome, data_nascimento=d_nasc, cpf=cpf, endereco=endereco)
